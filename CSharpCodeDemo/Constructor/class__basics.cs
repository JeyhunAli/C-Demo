...
namespace CSharpCodeDemo.Constructor
{
    /*
     * Constructor special type of the method in c# its going to be created inside a class it has to be same name with the 
     * class name 
     * it can be default constructor with no paramaterers and with the paramaters 
     * inside one class we can create as much as constructor we want 
     */
